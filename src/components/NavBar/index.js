        ...
        <div className="container">
          ...
          <div className="d-flex align-items-center">
            <section className="d-block d-sm-none">
              <a href="https://www.instagram.com/zero27barbering/">
              ...
              <a href="https://www.facebook.com/zero27barbering/">
          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul className="navbar-nav">
              <li className="nav-item">
                <a className="nav-link" href="http://calendly.com/zero27barbering" target="_blank" rel="noopener noreferrer">Book</a>
              </li>
              <li className="nav-item">
